...
STEP_SEQUENCES_INDEX_STR_CONN_OS = STEP_SEQUENCES_MAIN.index(STR_CONN_OS)
STEP_SEQUENCES_INDEX_STR_POGO_OS = STEP_SEQUENCES_MAIN.index(STR_POGO_OS)
STEP_SEQUENCES_INDEX_STR_LED = STEP_SEQUENCES_MAIN.index(STR_LED)
STEP_SEQUENCES_INDEX_STR_HALL_SENSOR = STEP_SEQUENCES_MAIN.index(STR_HALL_SENSOR)
STEP_SEQUENCES_INDEX_STR_VBAT_ID = STEP_SEQUENCES_MAIN.index(STR_VBAT_ID)
STEP_SEQUENCES_INDEX_STR_BATTERY = STEP_SEQUENCES_MAIN.index(STR_BATTERY)
STEP_SEQUENCES_INDEX_STR_PROX = STEP_SEQUENCES_MAIN.index(STR_PROX)
STEP_SEQUENCES_INDEX_STR_MIC = STEP_SEQUENCES_MAIN.index(STR_MIC)
...
STEP_SEQUENCES_COUNT = {
    ...
    STR_VBAT_ID: 1,
    STR_BATTERY: 1,
    STR_PROX: 9, # offset delete 25.0.421
    STR_MIC: 1,
}
...
STR_STATUS = "STATUS"
STR_SET = "SET"
STR_LAW_DATA_SAVE_PATH = "LAW PATH"
